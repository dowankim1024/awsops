...
- `topology/` — 3D/FossFLOW 공용 `TopologyGraph` 계약, `applyFilter`, `validateGraph`, 어댑터 3종(live/fixture/generator), `anonymize.ts`, `layout3d.ts`(3D 좌표, ADR-012) (ADR-010, vitest)
...
- `topology/` — `TopologyGraph` contract shared by 3D and FossFLOW views, `applyFilter`, `validateGraph`, three adapters (live/fixture/generator), `anonymize.ts`, `layout3d.ts` (3D coordinates, ADR-012) (ADR-010, vitest)
